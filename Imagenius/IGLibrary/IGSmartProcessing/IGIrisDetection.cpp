...
bool IGIrisDetection::detect_iris (const CxImage& faceImg, RECT eye1, RECT eye2, POINT & ptEye1, POINT & ptEye2)
{
bool temp;
...
ptEye1.x = eyeCoor1.x; ptEye1.y = eyeCoor1.y;
ptEye2.x = eyeCoor2.x; ptEye2.y = eyeCoor2.y;
}
else
{
temp =0;
