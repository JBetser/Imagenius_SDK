...
#define IGIPFILTER_PARAM_SCRIPT		L"Script"
...
typedef enum {IGIPFILTER_BLUR	= 0,
				...
				IGIPFILTER_PAPER = 33,
				IGIPFILTER_HALOSEPIA = 34, 
				IGIPFILTER_BW = 35,
				IGIPFILTER_FILTER5 = 36,
				IGIPFILTER_PYTHON = 37,
				IGIPFILTER_VIBRANCE = 38,

				IGIPINDEX_LPE = 100,
				IGIPINDEX_FACE = 101,
				IGIPINDEX_IRIS = 102 }	IGIPFILTER;
...
bool IndexFaces (IGSmartLayer& layer);
bool IndexIris (IGSmartLayer& layer);

class IGIPFaceEffectMessage : public IGIPFilterMessage
{
public:
	IGIPFaceEffectMessage (IGIPFACE_EFFECT eFaceEffectType, const std::tr1::function<bool (IGSmartLayer&)>& funcIndex, COLORREF col1, COLORREF col2, double dParam1, double dParam2, double dParam3, CxImage *pImage1, CxImage *pImage2)
	...
	IGIPFaceEffectMessage (IGIPFACE_EFFECT eFaceEffectType, COLORREF col1, COLORREF col2, double dParam1, double dParam2, double dParam3, CxImage *pImage1, CxImage *pImage2)
		: IGIPFilterMessage (IGIPFILTER_FACE_EFFECT)
		, m_funcIndex (std::tr1::bind(&IndexFaces, std::tr1::placeholders::_1))
		, m_eFaceEffectType (eFaceEffectType)
		, m_col1 (col1)
		, m_col2 (col2)
		, m_dParam1 (dParam1)
	...
	CxImage *m_pImage1;
	CxImage *m_pImage2;
	const std::tr1::function<bool (IGSmartLayer&)> m_funcIndex;
};
