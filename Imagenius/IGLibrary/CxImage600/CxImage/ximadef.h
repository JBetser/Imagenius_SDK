...
#define CXIMAGE_MORPHING_TYPE_RADIAL	0
#define CXIMAGE_MORPHING_TYPE_DIRECTIONNAL	1
#define CXIMAGE_MORPHING_TYPE_WIDE	2
#define CXIMAGE_MORPHING_TYPE_STAR	3
...
#define DLL_EXP
  ...
  #define cx_throw(message) {cx_error=true; if(strcmp(message,"")) strncpy(info.tcLastError,message,255); goto cx_error_catch;}
