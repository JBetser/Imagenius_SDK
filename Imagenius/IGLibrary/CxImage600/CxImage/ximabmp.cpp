...
bool CxImageBMP::Encode(CxFile * hFile)
{
	...
	ProgressSetMessage (L"Encoding Bitmap...");	
...
bool CxImageBMP::Decode(CxFile * hFile)
{
	...
	ProgressSetMessage (L"Decoding Bitmap...");	
  ...
  cx_try {
	...
	ProgressSetRange (bmpHeader.biHeight, 0);
	...
	::SendMessageW (info.hProgress, UM_PROGRESS_STEPIT, bmpHeader.biHeight, 0);
