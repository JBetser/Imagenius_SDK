 ...
 */
bool CxImage::AlphaCreate (BYTE level)
{
	if (pAlpha==NULL) {
...
BYTE* CxImage::AlphaGetPointer(const long x,const long y)
{
	...
	if (pAlpha) return pAlpha+x+y*head.biWidth;
	return 0;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
void CxImage::AlphaExport (std::ostream &os)
{
	int nSize = head.biWidth * head.biHeight;
	BYTE *pCopyAlpha = new BYTE [nSize];
	::memcpy_s (pCopyAlpha, nSize, pAlpha, nSize);
	os.write ((char *)&pCopyAlpha, sizeof (BYTE *));
}

void CxImage::AlphaSetChannel (void *p_alpha)
{
	if (!p_alpha)
		return;
	if (!pAlpha)
		CxImage::AlphaCreate();
	int nSize = head.biWidth * head.biHeight;
	::memcpy_s (pAlpha, nSize, p_alpha, nSize);
}
////////////////////////////////////////////////////////////////////////////////
