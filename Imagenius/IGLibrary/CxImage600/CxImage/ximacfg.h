...
#define CXIMAGE_SUPPORT_IG 1
#define CXIMAGE_SUPPORT_DZ 1
...
#define CXIMAGE_ERR_NODZTHREAD "no DeepZoom thread!!!"
#define CXIMAGE_ERR_BADPATH "invalid path"
...
#define CXIMAGE_MAX_DZTHREADS	32
#define CXIMAGE_DZ_DEFAULT_TILESIZE		256
