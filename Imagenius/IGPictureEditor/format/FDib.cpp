...
int FDib::write(LPDATAOBJECT pIDataObject, std::istream& is, HWND hwnd, int bufsize)
{  
	return writeToDataObject(pIDataObject, sid_, is, hwnd, bufsize);
}

int FDib::read(LPDATAOBJECT pIDataObject, std::ostream& os, int* size, HWND hwnd)
{
