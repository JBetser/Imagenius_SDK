...
int FIGLayer::write(LPDATAOBJECT pIDataObject, std::istream& is, HWND hwnd, int bufsize)
{  
	return writeToDataObject(pIDataObject, sid_, is, hwnd, bufsize);
}

int FIGLayer::read(LPDATAOBJECT pIDataObject, std::ostream& os, int* size, HWND hwnd)
{
